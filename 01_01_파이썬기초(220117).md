...
```
    ...
    '파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬파이썬'
...
```
    ...
    ----> 2 print('내 학점은 %d' % score)
          3 print('내 학점은 %f' % score)
...
```
    ...
    ----> 1 print('Hello, {}! 성적은 {}'.format(name,score))
...
```
    ...
    ----> 1 print(f'Hello, {name}! 성적은 {score}')
